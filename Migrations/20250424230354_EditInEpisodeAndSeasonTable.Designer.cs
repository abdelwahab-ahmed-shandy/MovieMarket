...
namespace MovieMart.Migrations
{
    ...
    [Migration("20250424230354_EditInEpisodeAndSeasonTable")]
    partial class EditInEpisodeAndSeasonTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MovieMart.Models.ActivityLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MovieMart.Models.OrderItem", b =>
                {
            ...
            modelBuilder.Entity("MovieMart.Models.ActivityLog", b =>
                {
                    b.HasOne("MovieMart.Models.ApplicationUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("MovieMart.Models.OrderItem", b =>
                {
                    ...
                    b.HasOne("MovieMart.Models.Order", "Order")
                        .WithMany()
